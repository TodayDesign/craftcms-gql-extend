...
class GqlExtendCraftql
{
    public static function init()
    {
		  GqlExtendCraftql::addFields();
    }
    ...
    function extendSchema (\markhuot\CraftQL\Events\AlterSchemaFields $event) {
        ...
        $event->schema->addField('breadcrumbs')
            ...
            ->resolve(function ($root, $args) {
                ...
                $breadcrumbs = GqlExtendCraftql::addBreadcrumb($root);
    ...
    static function addBreadcrumb($entry, $breadcrumbs = array()) {
        ...
        if ($parent) {
            return GqlExtendCraftql::addBreadcrumb($parent, $breadcrumbs);
        }
